...
import com.logic.gate.errormessage.ValidateErrorMessage;
...
public class EmployeeNotFoundExceptionRestHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ValidateErrorMessage> employeeNotFoundException(EmployeeNotFoundException enfe, WebRequest request){
